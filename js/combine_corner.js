...
function getImagePortion(c, imgObj, array, label){
    ...
    var list = {}
    list['combinedPHM'] = ['symmetric_mass_ratio', 'total_mass', 'total_mass_source', 'chi_eff', 'chirp_mass_source', 'dec', 'mass_1', 'mass_1_source', 'chirp_mass', 'tilt_2', 'ra', 'tilt_1', 'iota', 'phase', 'geocent_time', 'mass_ratio', 'phi_jl', 'a_1', 'luminosity_distance', 'a_2', 'chi_p', 'redshift', 'psi', 'mass_2_source', 'mass_2', 'phi_12'];
    list['SEOBNRv4PHM'] = ['luminosity_distance', 'geocent_time', 'mass_ratio', 'chirp_mass', 'dec', 'ra', 'psi', 'phase', 'a_1', 'a_2', 'tilt_1', 'tilt_2', 'phi_12', 'phi_jl', 'total_mass', 'mass_1', 'mass_2', 'symmetric_mass_ratio', 'mass_1_source', 'mass_2_source', 'chirp_mass_source', 'total_mass_source', 'iota', 'chi_eff', 'chi_p', 'redshift'];
    list['IMRPhenomPv3HM'] = ['a_1', 'a_2', 'chi_eff', 'chi_p', 'chirp_mass', 'chirp_mass_source', 'dec', 'geocent_time', 'luminosity_distance', 'mass_1', 'mass_1_source', 'mass_2', 'mass_2_source', 'mass_ratio', 'phase', 'phi_12', 'phi_jl', 'psi', 'ra', 'symmetric_mass_ratio', 'tilt_1', 'tilt_2', 'total_mass', 'total_mass_source', 'iota', 'redshift'];
    ...
    var data = {}
    data['combinedPHM'] = {'width': 200.00000000000006, 'height': 200.0, 'seperation': 9.999999999999943, 'x0': 100.0, 'y0': 100.0};
    data['SEOBNRv4PHM'] = {'width': 200.00000000000006, 'height': 200.0, 'seperation': 9.999999999999943, 'x0': 100.0, 'y0': 100.0};
    data['IMRPhenomPv3HM'] = {'width': 200.00000000000006, 'height': 200.0, 'seperation': 9.999999999999943, 'x0': 100.0, 'y0': 100.0};
